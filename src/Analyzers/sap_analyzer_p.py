...
class SapFlowAnalyzer:
    ...
    """
    def __init__(self, base_dir: str = "./data/raw/0.1.5/0.1.5/csv/sapwood", max_workers: int = 4):
    ...
    def _load_sapflow_data(self):
        ...
        for file in sapf_files:
            ...
            try:
                ...
                if flag_file.exists():
                    ...
                    process_input.append((location, plant_type, df, flags))
                else:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=self.max_workers) as executor:
          results = executor.map(self._process_sapflow_data, process_input) 
          for df, location, plant_type in results:
    ...
    def _process_sapflow_data(self, args) -> pd.DataFrame:
        """
        Process sapflow data with debugging information
        """
        location, plant_type, df, flags = args
        ...
        try:
            ...
            return daily_df, location, plant_type
