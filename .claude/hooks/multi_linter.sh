...
# Windows: point claude subprocess to Git Bash (required for Phase 3 subprocess delegation)
export CLAUDE_CODE_GIT_BASH_PATH="${CLAUDE_CODE_GIT_BASH_PATH:-E:/Git/usr/bin/bash.exe}"
