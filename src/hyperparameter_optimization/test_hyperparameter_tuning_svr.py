...
param_grid = [
   
    {
        ...
        'degree': [4, 5],  # Polynomial degree
        'coef0': [1,],  # Independent term in kernel
        'epsilon': [0.5, 1]
    }
]

optimizer = MLOptimizer( param_grid=param_grid, scoring='r2', model_type='svm', task='regression')
...
# set a suptitle
fig.suptitle('svr Model Results')
# layout the plot
plt.tight_layout()
plt.show()
...
# save the plot
fig.savefig('./plots/svr_result.png')
...
# set a suptitle
fig1.suptitle('Scatter Plot of Predicted and True Values for svr Model')
# layout the plot
plt.tight_layout()

plt.show()
# save the plot
fig1.savefig('./plots/svr_scatter.png')