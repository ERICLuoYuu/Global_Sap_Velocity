...
class ERA5LandGEEProcessor:
    ...
    def get_era5land_variable_from_gee(self, variable, year, month, day, scale=None, shapefile=None, region=None):
        ...
        try:
            ...
            # Set up date range - FIXED
            if month is not None:
                if day is not None:
                    # Start from the specified day, not from day 1
                    ...
                    # If only month is specified (not day), get the whole month
                ...
                # If neither month nor day specified, get whole year
                ...
                for var_name in prediction_vars:
                    try:
                        ...
                        if data_var:
                            ...
                            print(f"Variable {var_name} at ({lat}, {lon}): min={ts.min().values}, max={ts.max().values}, has_nans={np.isnan(ts.values).any()}")
    ...
    def merge_prediction_files(self, file_paths, output_file=None):
        ...
        return str(output_file)
    def process_month_parallel(self, variables, year, month, shapefile=None, num_workers=None, output_dir=None, processor=None):
        """
        ...
        for day in range(1, days_in_month + 1):
            ...
            process_args.append((year, month, day, variables, shapefile, output_dir, processor))
